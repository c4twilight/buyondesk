<center><h3>Matched University</h3></center>
@foreach($sells_with_UN as $keys => $values)
	@foreach($values as $key => $value)
		<div class="panel" onclick='window.location.href = "/buy/" + {{$value["id"]}} '>
		<div class="panel-title">
			<center><span class="label label-success university_name">{{auth()->user()->getUniversityName($value['user_id'])}}</span></center>
		</div>
			<div class="panel-body">
				<div class="col-md-3 col-sm-3 col-xm-3 pull-left">
